...
// PowerUp inherits its state and rendering functions from GameObject but also holds extra information to state its active duration and 
// whether it is activated or now. The type of PowerUp is stored as a string.
